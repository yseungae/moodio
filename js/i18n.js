export const translations = {
  ko: {
    ...
    searching: "노래를 찾고 있어요...", noResults: "검색 결과가 없어요.", searchError: "음악을 불러오지 못했어요. 잠시 후 다시 시도해주세요.",
    ...
    monthlyArchive: "월별 음악 일기", previousMonth: "이전 달", nextMonth: "다음 달", share: "공유하기", monthProgress: "월별 기록 진행도", monthSongCount: "{count} / {total}곡", noEntries: "아직 이 달에 기록한 노래가 없어요.",
  ...
  en: {
    ...
    searching: "Searching for songs...", noResults: "No songs found.", searchError: "Couldn’t load songs. Please try again.",
    ...
    monthlyArchive: "Monthly music journal", previousMonth: "Previous month", nextMonth: "Next month", share: "Share", monthProgress: "Monthly recording progress", monthSongCount: "{count} / {total} songs", noEntries: "No songs recorded this month yet.",
    edit: "Edit", more: "More", less: "Show less", sharedDiary: "Shared music journal", sharedSubtitle: "A month of songs and the moments behind them", shareEmpty: "There are no entries to share.",
